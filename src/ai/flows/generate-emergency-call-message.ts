...
Lütfen {{{emergencyContactName}}} için kısa, nazik ve bilgilendirici bir konuşma metni oluştur. {{{userName}}} isimli kişinin alarmını kaçırdığını ve kendisine ulaşamadığımızı, bu aramanın CanEmanet sisteminden gelen otomatik bir uyarı olduğunu belirt. Onu kontrol etmesini tavsiye et.
